...
const included = [
  "Получение первичной информации о бизнесе клиента",
  "Анализ ниши и конкурентов в интернете (до 7–8 игроков)",
  "Составление аватаров клиентов",
  "Анализ потребностей, слабых сторон и предпочтений клиентов, сегментирование аудитории — исследование целевых групп потребителей",
  "Анализ психотипов и разработка ключевых обращений к каждой группе ЦА",
  "Поиск и выделение конкурентных преимуществ — чем компания сильнее других",
  "Краткое и ёмкое описание того, чем занимается компания и зачем создана, — ключевой посыл потребителю",
  "Анализ миссии бренда, её характера и настроения; система эмоциональных и рациональных ценностей, глобальная цель",
  "Разработка уникальности — особенности торговой марки (ключевые отличия и преимущества) для привлечения потребителей",
  "Создание сильного позиционирования компании",
  "Составление содержания бренда — чем занимается компания, какие сферы охватывает, какую пользу приносит потребителям",
  "Составление уникального торгового предложения (УТП), которое выгодно отличает компанию и продукт от конкурентов",
  "Портрет первого лица компании (владельца, гендиректора) — кто он, его история и почему ему можно доверять",
  "Краткая история возникновения идеи создания продукта или компании и удивительные случаи, связанные с брендом",
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 space-y-24">
        ...
        {/* Блок 3 — С какими задачами обращаются */}
